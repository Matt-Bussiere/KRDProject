...
def Help2():
    ...
    HELP27 = Message(HELP2WINDOW, text ='7: To calculate the R values remember the equation for K is Ko*exp((E/R)*(1/KTR - 1/T) and the Kc dH_rxn replaces E so units will be found using these principles.', width=600)
    HELP21.pack()
    HELP22.pack()
    HELP23.pack()
    HELP24.pack()
